      ! ===========================================
      ! 
      !   SIM. MODELO DE ISING 2D - GLAUBER
      !
      ! ===========================================
      PROGRAM GLAUBER_2D
      IMPLICIT NONE
      ...
      REAL*8 exponentials(-DIM:DIM),E,M,energies(STEPS),mags(STEPS),
     &       avg_e,avg_m,avg_e2
      ...
      do i=int((ftemp-itemp)/dtemp),0,-1
        ...
        do k = -DIM, DIM
          exponentials(k) = 1/(exp(2.0*JMAG*2.0*k/(itemp+i*dtemp))+1)
        end do
     ...
     &                         exponentials)
        ...
        write(10,*) itemp+i*dtemp,avg_e/10000/N,avg_m/10000/N,
